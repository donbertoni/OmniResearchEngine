TRANSLATIONS = {
    "PT": {
        ...
        "shared_tenant_notice": "⚠️ Este terminal ainda é single-tenant: toda conta criada aqui compartilha os mesmos gatilhos, automações e credenciais.",
        ...
        "white_label_title": "🏛️ Marca White-Label",
        "company_name_label": "Nome da Empresa (exibido no título):",
        "cnpi_code_label": "Código CNPI do Responsável Técnico:",
    ...
    "EN": {
        ...
        "shared_tenant_notice": "⚠️ This terminal is still single-tenant: every account created here shares the same triggers, automations and credentials.",
        ...
        "white_label_title": "🏛️ White-Label Branding",
        "company_name_label": "Company Name (shown in the title):",
        "cnpi_code_label": "Technical Officer CNPI Code:",
